...
- ⚠️ **Если на основном домене уже работает другой сайт**, используйте **поддомен** (например, `webapp.ikurganskiy.ru`)
- См. файл `NGINX_SUBDOMAIN_SETUP.md` для инструкции по настройке поддомена
